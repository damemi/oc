...
require (
	...
	k8s.io/kubernetes v0.19.0-rc.0
...
replace (
	...
	k8s.io/sample-cli-plugin => k8s.io/sample-cli-plugin v0.19.0-rc.0
	k8s.io/sample-controller => k8s.io/sample-controller v0.19.0-rc.0
)
